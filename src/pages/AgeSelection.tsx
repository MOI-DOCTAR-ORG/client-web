      ...
      <main className="w-full max-w-lg px-margin-mobile z-10 flex flex-col items-center">
        ...
        <div className="bg-surface-container-lowest w-full rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-outline-variant p-stack-lg flex flex-col gap-stack-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-stack-md mt-4">
            <button className="flex-1 py-3 px-6 rounded-full border border-primary text-primary font-label-md text-label-md hover:bg-surface-container-low transition-colors duration-200 text-center">
              Back
            </button>
            <button className="flex-1 py-3 px-6 rounded-full bg-primary text-on-primary font-label-md text-label-md hover:bg-[#1A2AC2] transition-colors duration-200 text-center shadow-sm">
              Continue
            </button>
          </div>
        </div>
