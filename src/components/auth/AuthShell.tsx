...
export default function AuthShell({
  ...
  return (
    <main className="relative flex min-h-[100dvh] overflow-hidden bg-[linear-gradient(135deg,#050816 0%,#0a0f1e 48%,#0d1a2d 100%)] px-3 py-3 text-on-background sm:px-5 sm:py-5 lg:p-6">
      <div className="pointer-events-none absolute inset-0 opacity-30 [background-image:linear-gradient(rgba(0,240,255,0.08)_1px,transparent_1px),linear-gradient(90deg,rgba(0,240,255,0.08)_1px,transparent_1px)] [background-size:42px_42px]" />

      <div className={`relative mx-auto grid min-h-[calc(100dvh-1.5rem)] w-full max-w-[1240px] overflow-hidden rounded-[28px] border border-[rgba(0,240,255,0.12)] bg-[rgba(10,15,30,0.55)] shadow-[0_30px_90px_rgba(0,0,0,0.4),0_0_80px_rgba(0,240,255,0.04)] backdrop-blur-xl sm:min-h-[calc(100dvh-2.5rem)] lg:min-h-[calc(100dvh-3rem)] ${gridClass}`}>
            ...
            <header className="mb-6 flex flex-col gap-5 sm:mb-7">
              <div className="flex items-center justify-between gap-4">
                <div className="flex min-w-0 items-center gap-4">
                  <div className="relative">
                    ...
                    />
                    <span className="absolute -inset-3 rounded-full bg-[rgba(0,240,255,0.08)] blur-xl motion-safe:animate-[auth-ring-breathe_4s_ease-in-out_infinite]" aria-hidden="true" />
                  </div>
                  <div className="min-w-0">
                    <p className="font-headline-md text-xl font-extrabold leading-7 text-[#00f0ff] sm:text-2xl">
                      {eyebrow}
                    </p>
                ...
                <div className="hidden min-h-10 items-center gap-2 rounded-full border border-[rgba(0,240,255,0.2)] bg-[rgba(0,240,255,0.06)] px-3 text-xs font-extrabold text-[#00f0ff] shadow-[0_0_16px_rgba(0,240,255,0.08)] sm:inline-flex">
              ...
              <div className="flex flex-wrap gap-2 lg:hidden" aria-label="Auth security highlights">
                {trustItems.slice(0, 2).map((item) => (
                  <span
                    key={item.label}
                    className="inline-flex min-h-9 items-center gap-2 rounded-full border border-[rgba(0,240,255,0.12)] bg-[rgba(0,240,255,0.04)] px-3 text-xs font-bold text-[rgba(148,163,184,0.9)] backdrop-blur-sm"
                  >
        ...
        <aside className={`relative hidden min-h-full overflow-hidden bg-[linear-gradient(150deg,#050816_0%,#0a1628_40%,#0d2137_70%,#050816_100%)] p-8 text-on-primary-container lg:flex lg:flex-col lg:justify-between xl:p-10 ${visualOrderClass}`}>
          <div className="pointer-events-none absolute inset-0 opacity-20 [background-image:linear-gradient(rgba(0,240,255,0.15)_1px,transparent_1px),linear-gradient(90deg,rgba(0,240,255,0.15)_1px,transparent_1px)] [background-size:34px_34px]" />
          <div className="pointer-events-none absolute right-8 top-8 h-[calc(100%-4rem)] w-px bg-[rgba(0,240,255,0.12)]" />

          <div className="pointer-events-none absolute left-6 top-10 h-40 w-40 rounded-full bg-[rgba(0,240,255,0.06)] blur-3xl motion-safe:animate-[auth-ring-breathe_6s_ease-in-out_infinite]" aria-hidden="true" />
          ...
          <div className="pointer-events-none absolute left-1/3 top-1/2 h-24 w-24 rounded-full bg-[rgba(0,240,255,0.04)] blur-2xl motion-safe:animate-[auth-ring-breathe_5s_ease-in-out_2s_infinite]" aria-hidden="true" />
            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                <img
                  ...
                  aria-hidden="true"
                />
                <span className="absolute -inset-4 rounded-full bg-[rgba(0,240,255,0.1)] blur-2xl motion-safe:animate-[auth-ring-breathe_5s_ease-in-out_infinite]" aria-hidden="true" />
              </div>
              <div>
          ...
          <div className="relative z-10 mx-auto flex w-full max-w-[470px] flex-col py-8">
            <div className="rounded-[30px] border border-[rgba(0,240,255,0.1)] bg-[rgba(10,15,30,0.35)] p-6 shadow-[0_28px_70px_rgba(0,0,0,0.25),0_0_40px_rgba(0,240,255,0.04)] backdrop-blur-xl motion-safe:animate-[auth-rise-in_620ms_cubic-bezier(0.16,1,0.3,1)_both]">
              <div className="flex items-start justify-between gap-5 border-b border-[rgba(0,240,255,0.08)] pb-5">
                <div>
                ...
                <Icon icon="health_and_safety" size="xl" className="text-[#00f0ff]" aria-hidden="true" />
              </div>

              <div className="relative mx-auto my-8 grid h-[19rem] w-[19rem] place-items-center">
                <span className="absolute inset-0 rounded-full border-2 border-[rgba(0,240,255,0.12)]" aria-hidden="true" />
                <span className="absolute inset-4 rounded-full border-[5px] border-[rgba(0,240,255,0.3)] shadow-[0_0_54px_rgba(0,240,255,0.15)] motion-safe:animate-[auth-ring-breathe_3.4s_ease-in-out_infinite]" aria-hidden="true" />
                <span className="absolute inset-9 rounded-full border-2 border-dashed border-[rgba(0,240,255,0.2)] motion-safe:animate-[auth-ring-spin_14s_linear_infinite]" aria-hidden="true" />
                <span className="absolute inset-[4.35rem] rounded-full border-2 border-[rgba(0,240,255,0.15)] motion-safe:animate-[auth-ring-spin_18s_linear_infinite_reverse]" aria-hidden="true" />

                {animatedMedicalIcons.map((item) => (
                  <div
                    key={item.icon}
                    className={`absolute z-20 grid h-11 w-11 place-items-center rounded-2xl border border-[rgba(0,240,255,0.15)] bg-[rgba(10,15,30,0.5)] text-[#00f0ff] shadow-[0_0_16px_rgba(0,240,255,0.1),0_12px_30px_rgba(0,240,255,0.08)] backdrop-blur ${item.stationClass} ${item.stationPulseClass}`}
                    aria-hidden="true"
                  >
                ...
                <div className="relative z-10 grid h-44 w-44 place-items-center overflow-hidden rounded-full border-[5px] border-[rgba(0,240,255,0.4)] bg-[radial-gradient(circle_at_35%_20%,#0d1a2d_0%,#0030e6_72%,#0080ff_100%)] shadow-[0_0_40px_rgba(0,240,255,0.25),0_28px_64px_rgba(0,240,255,0.15)] backdrop-blur-xl">
                  ...
                  <div className="absolute inset-x-[-24%] bottom-[-10%] h-[120%] origin-bottom overflow-hidden rounded-[46%] bg-[linear-gradient(180deg,rgba(0,240,255,0.85)_0%,rgba(0,128,255,0.9)_48%,rgba(0,38,214,0.95)_100%)] shadow-[inset_0_18px_40px_rgba(255,255,255,0.15)] motion-safe:animate-[auth-real-water-fill_12s_ease-in-out_infinite]" aria-hidden="true">
                    <span className="absolute -top-5 left-[-26%] h-11 w-[154%] rounded-[48%] bg-[rgba(0,240,255,0.4)] motion-safe:animate-[auth-wave-drift_3.2s_linear_infinite]" />
              ...
              <div className="grid gap-3">
                {workflowItems.map((item, index) => (
                  <div
                    key={item.label}
                    className="flex items-center gap-3 rounded-2xl border border-[rgba(0,240,255,0.08)] bg-[rgba(10,15,30,0.3)] p-3 backdrop-blur-sm motion-safe:animate-[auth-rise-in_520ms_cubic-bezier(0.16,1,0.3,1)_both]"
                    style={{ animationDelay: `${120 + index * 70}ms` }}
                  >
                    <div className="grid h-10 w-10 shrink-0 place-items-center rounded-xl border border-[rgba(0,240,255,0.12)] bg-[rgba(0,240,255,0.06)] text-[#00f0ff] shadow-[0_0_12px_rgba(0,240,255,0.08)]">
          ...
          <div className="relative z-10 grid gap-3">
            {trustItems.map((item, index) => (
              <div
                key={item.label}
                className="flex items-center gap-3 rounded-full border border-[rgba(0,240,255,0.1)] bg-[rgba(0,240,255,0.04)] px-4 py-3 font-body-md text-sm font-bold text-[#e0e7ff] backdrop-blur-sm motion-safe:animate-[auth-rise-in_520ms_cubic-bezier(0.16,1,0.3,1)_both]"
                style={{ animationDelay: `${180 + index * 70}ms` }}
              >
                <div className="grid h-8 w-8 place-items-center rounded-full bg-[rgba(0,240,255,0.08)] text-[#00f0ff] shadow-[0_0_10px_rgba(0,240,255,0.1)]">
                  <Icon icon={item.icon} size="sm" aria-hidden="true" />
                </div>
