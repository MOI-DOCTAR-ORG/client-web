export default function LoadingSpinner({ text = 'Loading...' }: { text?: string }) {
  return (
    <div className="relative flex min-h-[100dvh] items-center justify-center overflow-hidden bg-[linear-gradient(135deg,var(--color-background)_0%,var(--color-surface-container-low)_48%,var(--color-primary-container)_100%)] px-4 py-6 text-on-background">
      <div className="w-full max-w-sm rounded-[28px] border border-[var(--glass-border)] bg-[var(--glass-bg)] backdrop-blur-xl p-8 text-center shadow-[0_24px_70px_rgba(0,240,255,0.08)] motion-safe:animate-[auth-rise-in_520ms_cubic-bezier(0.16,1,0.3,1)_both]">
