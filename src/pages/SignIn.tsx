    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-surface">
      <div className="w-full max-w-md bg-surface-container-lowest rounded-xl shadow-level-1 border border-secondary-fixed p-8 flex flex-col gap-6 relative z-10">
        ...
        <div className="flex justify-center gap-4">
          <button onClick={() => { signIn('google-user@example.com'); navigate('/otp-verification') }} className="w-12 h-12 flex items-center justify-center rounded-full border border-secondary-fixed bg-surface-container-lowest hover:bg-surface-container-low transition-colors" aria-label="Sign in with Google">
          ...
          <button onClick={() => { signIn('apple-user@example.com'); navigate('/otp-verification') }} className="w-12 h-12 flex items-center justify-center rounded-full border border-secondary-fixed bg-surface-container-lowest hover:bg-surface-container-low transition-colors" aria-label="Sign in with Apple">
            <svg viewBox="0 0 24 24" className="w-5 h-5">
