      ...
      <main className="w-full max-w-md px-margin-mobile md:px-0 relative z-10">
        ...
        <div className="bg-surface-container-lowest rounded-xl border border-secondary-fixed shadow-[0px_4px_20px_rgba(0,0,0,0.03)] p-8">
          ...
          <div className="flex justify-center gap-4 mb-6">
            <button onClick={() => { signUp('google-user@gmail.com', 'google-auth'); navigate('/otp-verification') }} className="w-12 h-12 flex items-center justify-center rounded-full border border-secondary-fixed bg-white hover:bg-surface-container-low transition-colors" aria-label="Sign up with Google">
            ...
            <button onClick={() => { signUp('apple-user@icloud.com', 'apple-auth'); navigate('/otp-verification') }} className="w-12 h-12 flex items-center justify-center rounded-full border border-secondary-fixed bg-white hover:bg-surface-container-low transition-colors" aria-label="Sign up with Apple">
              <svg viewBox="0 0 24 24" className="w-5 h-5">
